...
checkboxDarkMode.addEventListener('click', () => {
    if (checkboxDarkMode.checked == true) {
        ...
        // inmg home
        document.querySelector('#home .image').innerHTML = ` <img src="anh3.jpg" alt="" class="front-img">
        ...
        // logo
        document.querySelector('.logo img').src = "logo2.png"
...
`
        ...
        // inmg home
        document.querySelector('#home .image').innerHTML = ` <img src="anh1.jpg" alt="" class="front-img">
